...
internal sealed class ServiceEventSource : EventSource
{
    ...
    [Event(ServiceTypeRegisteredEventId, Level = EventLevel.Informational, Message = "ServiceType host process {0} registered service type {1}", Keywords = Keywords.ServiceInitialization)]
    ...
    [Event(ServiceHostInitializationFailedEventId, Level = EventLevel.Error, Message = "ServiceType host initialization failed", Keywords = Keywords.ServiceInitialization)]
    ...
    [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, Message = "ServiceType request '{0}' started", Keywords = Keywords.Requests)]
    ...
    [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, Message = "ServiceType request '{0}' finished", Keywords = Keywords.Requests)]
