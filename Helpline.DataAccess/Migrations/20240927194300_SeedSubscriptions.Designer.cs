...
namespace Helpline.DataAccess.Migrations
{
    ...
    [Migration("20240927194300_SeedSubscriptions")]
            ...
            modelBuilder.Entity("Helpline.Shared.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2024, 9, 27, 12, 42, 59, 308, DateTimeKind.Local).AddTicks(3136),
                            Description = "24/7 access to Showcase RV Hub site for RV rentals",
                            IsActive = false,
                            Price = 20.00m,
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2024, 9, 27, 12, 42, 59, 308, DateTimeKind.Local).AddTicks(3199),
                            Description = "24/7 access to Showcase RV Hub site for customers",
                            IsActive = false,
                            Price = 125.00m,
                            SubscriptionType = (byte)2,
                            Term = "Annual"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2024, 9, 27, 12, 42, 59, 308, DateTimeKind.Local).AddTicks(3203),
                            Description = "24/7 access to Showcase RV Hub with a certified tech on call",
                            IsActive = false,
                            Price = 200.00m,
                            SubscriptionType = (byte)3,
                            Term = "Annual"
                        });
                });
