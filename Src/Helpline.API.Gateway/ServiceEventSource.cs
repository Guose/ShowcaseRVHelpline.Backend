...
namespace Helpline.API.Gateway
{
    [EventSource(Name = "MyCompany-HelplineBackend-Helpline.API.Gateway")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(ServiceTypeRegisteredEventId, Level = EventLevel.Informational, Message = "ServiceClass host process {0} registered service type {1}", Keywords = Keywords.ServiceInitialization)]
        ...
        [Event(ServiceHostInitializationFailedEventId, Level = EventLevel.Error, Message = "ServiceClass host initialization failed", Keywords = Keywords.ServiceInitialization)]
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Informational, Message = "ServiceClass request '{0}' started", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Informational, Message = "ServiceClass request '{0}' finished", Keywords = Keywords.Requests)]
