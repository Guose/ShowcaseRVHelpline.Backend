...
using Helpline.API.Controller.Config.Access;
using Helpline.API.Controller.Config.Filters;
using Helpline.API.Gateway.Extensions;
...
namespace Helpline.API.Gateway
{
    ...
    internal sealed class APIGateway : StatelessService
    {
        ...
        public APIGateway(StatelessServiceContext context)
            : base(context)
        {
            // ManifestEmbeddedFileProvider = new ManifestEmbeddedFileProvider(typeof(APIGateway).Assembly);
        }
